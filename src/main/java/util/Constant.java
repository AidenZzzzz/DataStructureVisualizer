...
public class Constant {
    ...
    public static final int STACK_INIT_Y = 0;

    public static final int QUEUE_INIT_X = FRAME_WIDTH /2-NODE_WIDTH/2;
    public static final int QUEUE_INIT_Y = 0;

    public static final int LL_INIT_X = 0;
    public static final int LL_INIT_Y = GRAPHICS_H/2;
}
